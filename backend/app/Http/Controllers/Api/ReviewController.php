...
class ReviewController extends Controller
{
    ...
    {
        // Récupérer TOUS les avis du produit (pas seulement ceux de l'utilisateur connecté)
    ...
    /**
     * Vérifier si l'utilisateur connecté a déjà laissé un avis pour un produit
     */
