            ...
            ->map(function ($favorite) {
                return [
                    ...
                    'product' => $favorite->vintageProduct ? [
                            ...
                            'final_price' => $favorite->vintageProduct->final_price,
                            'promotion' => $favorite->vintageProduct->promotion,
                            'image_url' => $favorite->vintageProduct->image_url,
                            'status' => $favorite->vintageProduct->status,
